...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) => Product(
        ...
        productReview: json["product_review"] == null
            ? []
            : List<ProductWishlistElement>.from(json["product_review"]!
                .map((x) => ProductWishlistElement.fromJson(x))),
        productWishlist: json["product_wishlist"] == null
            ? null
...
class Variant {
  ...
  factory Variant.fromJson(Map<String, dynamic> json) => Variant(
        ...
        metadata: json["metadata"] == null
            ? null
            : VariantMetaData.fromJson(json["metadata"]),
...
class VariantMetaData {
  ...
  factory VariantMetaData.fromJson(Map<String, dynamic> json) =>
      VariantMetaData(
        ...
        basePriceAmount: _toInt(json["base_price_amount"]),
        presetOptions: _parsePresetOptions(json),
      );
  ...
  static List<int> _parsePresetOptions(Map<String, dynamic> metadata) {
    final config = metadata["preset_options_config"];
    if (config is List) {
      final values = config
          .whereType<Map>()
          .where((entry) =>
              entry["enabled"] != false && entry["enabled"] != "false")
          .map((entry) => _toInt(entry["value"]))
          .whereType<int>()
          .where((value) => value > 0)
          .toSet()
          .toList()
    ...
    final presetOptions = metadata["preset_options"];
    if (presetOptions is List) {
      final values = presetOptions
          .map(_toInt)
          .whereType<int>()
          .where((value) => value > 0)
          .toSet()

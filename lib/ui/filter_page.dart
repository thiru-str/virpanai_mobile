...
class _FilterPageState extends State<FilterPage> {
  ...
  Future<void> _loadFacets() async {
    ...
    try {
      ...
      // Older GoWelMart backends do not expose product-filter-facets.
      // Keep the filter choices usable until that endpoint is available.
      try {
        final api = ApiService();
        final collections = await api.listCollections(context);
        final categories = await api.listCategories(context);

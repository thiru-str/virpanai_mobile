...
CartResponse addCartResponseFromJson(String str) =>
...
class Cart {
  ...
  factory Cart.fromJson(Map<String, dynamic> json) => Cart(
        ...
        promotions: json["promotions"] == null
            ? []
            : List<Promotion>.from(json["promotions"]!
                .where((x) => x != null)
...
class Item {
  ...
  factory Item.fromJson(Map<String, dynamic> json) => Item(
        ...
        rawDiscountSubtotal: json["raw_discount_total"] == null
            ? null
            : Raw.fromJson(json["raw_discount_total"]),
        ...
        rawReturnDismissedTotal: json["raw_return_received_total"] == null
            ? null
            : Raw.fromJson(json["raw_return_received_total"]),
...
class PaymentSession {
  ...
  factory PaymentSession.fromJson(Map<String, dynamic> json) => PaymentSession(
        ...
        context:
            json["context"] == null ? null : Metadata.fromJson(json["context"]),
        status: json["status"],

    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            Positioned(
                top: 0, right: 0, child: SvgPicture.asset(AppAssets.bg_top)),
            Positioned(
                bottom: 0,
                left: 0,
                            ...
                            children: [
                              ...
                              RichText(
                                text: TextSpan(
                                  ...
                                  children: [
                                    const TextSpan(
                                        text: '${AppStrings.code_sent}\n'),
                                    TextSpan(
                                      text: '${widget.countryCode} ',
                                      style: TextStyle(
                                        color: AppColors
                                            .primary, // Or any color you prefer for country code
                                        fontWeight: FontWeight.bold,
                                      ),
                                    ),
                                    TextSpan(
                                      ...
                                      style: TextStyle(
                                        color: AppColors
                                            .primary, // Or any color you prefer for phone number
                                        fontWeight: FontWeight.bold,
                                      ),
                                    ),
                                  ],
  ...
  void sendOtp() async {
    try {
      ...
      final sendOtpResponse =
          await apiService.sendOtp(context, widget.countryCode, widget.phoneNo);
  ...
  void verifyOtp() async {
    try {
      ...
      await SharedPreferencesUtil()
          .saveString('token', verifyOtpResponse!.token!);

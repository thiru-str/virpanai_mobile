    ...
    child: Container(padding: const EdgeInsets.all(16),
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          Expanded(child: Text(content.layoutTitle ?? 'You are 250 points away from Gold', style: FontUtils.primaryFontStyle(fontSize: 14, fontWeight: FontWeight.w800, color: cmsCardText(context, AppColors.textColor)))),
        ]),
        const SizedBox(height: 12),
        ...
        Text(content.layoutSubTitle ?? '750 / 1000 points', style: FontUtils.primaryFontStyle(fontSize: 11, fontWeight: FontWeight.w400, color: cmsCardText(context, AppColors.textColor50))),
      ]),
    ),
  );
}
...
class RatingSummary1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Container(padding: const EdgeInsets.all(18),
      ...
      child: Row(children: [
        Column(children: [
          Text('4.8', style: FontUtils.primaryFontStyle(fontSize: 36, fontWeight: FontWeight.w800, color: cmsCardText(context, AppColors.textColor))),
          Row(children: [for (int i = 0; i < 5; i++) const Icon(Icons.star, size: 12, color: Color(0xFFF5A623))]),
          const SizedBox(height: 2),
          Text('24k reviews', style: FontUtils.primaryFontStyle(fontSize: 10, fontWeight: FontWeight.w400, color: cmsCardText(context, AppColors.textColor50))),
        ]),
        ...
        Expanded(child: Column(children: [
          for (final r in [['5', 0.8], ['4', 0.14], ['3', 0.04], ['2', 0.01], ['1', 0.01]])
            Padding(padding: const EdgeInsets.only(bottom: 5), child: Row(children: [
              Text('${r[0]}', style: FontUtils.primaryFontStyle(fontSize: 11, fontWeight: FontWeight.w600, color: cmsCardText(context, AppColors.textColor50))),
